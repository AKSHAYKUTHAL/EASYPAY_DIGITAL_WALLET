    ...
    if request.method == 'POST':
        ...
        if sender_account.account_balance >= Decimal(original_currency_amount):
            new_transaction = TransactionForeign.objects.create(
                ...
                transaction_status = 'deposit_processing',
                transaction_type = 'forex_deposit',
...
def foreign_deposit_confirm_process(request,transaction_id):
    ...
    if request.method == 'POST':
        if transaction_foreign.transaction_status != 'deposit_completed':

            pin_number = request.POST.get('pin_number')

            if pin_number == sender_account.pin_number:
                transaction_foreign.transaction_status = "deposit_completed"
